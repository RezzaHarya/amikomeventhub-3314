    ...
    <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
        <div class="px-8 py-6 bg-slate-50/50 border-b flex justify-between items-center gap-4">
            <input type="text" placeholder="Cari nama kategori..."
                class="flex-1 max-w-md px-5 py-3 rounded-xl border-slate-200 border bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition">
            
            <button class="px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition shadow-sm flex items-center gap-2">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6">
                            <p class="font-black text-slate-800 text-lg">Seminar</p>
                        </td>
                        <td class="px-8 py-6">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6">
                            <p class="font-black text-slate-800 text-lg">Konser</p>
                        </td>
                        <td class="px-8 py-6">
                            <div class="flex gap-2 justify-center">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6">
                            <p class="font-black text-slate-800 text-lg">Workshop</p>
                        </td>
                        <td class="px-8 py-6">
                            <div class="flex gap-2 justify-center">
                                <button class="p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition">
