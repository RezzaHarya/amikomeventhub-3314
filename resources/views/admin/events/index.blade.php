...
<div class="mb-4 text-right">
    <a href="{{ route('admin.events.create') }}" class="inline-flex items-center gap-2 p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
        </svg>
        <span class="font-bold pr-2">Tambah Event Baru</span>
    </a>
</div>
                ...
                @forelse($events as $index => $event)
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6">
                            ...
                            @else
                                <img src="https://placehold.co/160x200/6366f1/ffffff?text=Event" class="w-16 h-20 rounded-xl object-cover shadow-sm">
                            @endif
                        </td>
                        <td class="px-8 py-6">
