...
@section('content')
    ...
    <main class="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
        <div class="relative">
            <img src="assets/concert.png" alt="Event Image" class="rounded-[2rem] shadow-2xl w-full object-cover aspect-[4/5] object-center">
            <div class="absolute -bottom-6 -left-6 glass p-6 rounded
