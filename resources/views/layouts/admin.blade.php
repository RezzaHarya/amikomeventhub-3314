...
<body class="bg-slate-50 text-slate-900 flex min-h-screen">
    ...
    <aside class="w-64 bg-indigo-900 text-indigo-100 flex flex-col p-6 space-y-8 sticky top-0 h-screen">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-3 px-6 py-3 text-slate-300 hover:text-white hover:bg-white/10 transition rounded-xl mb-2">
            ...
            <a href="{{ route('admin.partners.index') }}" class="flex items-center gap-3 px-6 py-3 text-slate-300 hover:text-white hover:bg-white/10 transition rounded-xl mb-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
